...
public class PhyloTreeUtils {
    ...
    public static String findReticulateLabel(String label) {
        ...
        int pos = label.lastIndexOf("#");  // look for last instance of '#',  followed by H or L
    ...
    /**
     * determines whether the edge leading to this instance of a reticulate node should be treated as
     * an acceptor edge, i.e. as a tree edge that is the target of of HGT edge
     * At most one such edge per reticulate  node is allowed
     *
     * @param label
     * @return true, if label contains ## followed by H L h or l
     */
     ...
     *
     * @param label
     * @return string without label or null, if string only consisted of substring
     */
    ...
    /**
     * determines whether it is ok to descend down an edge in a recursive traverse of a tree.
     * It is ok if the edge is not a reticulate edge or is the first reticulate edge that enters f
     *
     * @param tree
     * @param e
     * @param v
    ...
    /**
     * determines whether the two trees are single-labeled trees on the same taxon sets
     *
     * @param tree1
     * @param tree2
     * @return true, if ok
