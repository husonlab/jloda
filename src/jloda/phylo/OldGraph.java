/*
 * OldGraph.java Copyright (C) 2019. Daniel H. Huson
 *
 ...
 */
public class OldGraph extends Graph {
     ...
     */
    public NodeArray<Node> copy(OldGraph src) {
        clear();
     ...
     */
    public NodeArray<Node> copy(OldGraph src, NodeArray<Node> oldNode2NewNode, EdgeArray<Edge> oldEdge2NewEdge) {
        clear();
        ...
        for (Node v = src.getFirstNode(); v != null; v = src.getNextNode(v)) {
            ...
            nodeLabels.put(w, src.nodeLabels.get(v));
    ...
    public double getWeight(Edge e) {
        if (edgeWeights.getValue(e) == null) // not defined
            return 1;
        else
    ...
    public List<Integer> getNode2Taxa(Node v) {
        if (node2taxa.get(v) == null)
            node2taxa.put(v, new ArrayList<Integer>()); // lazy initialization
     ...
     */
    public NodeArray<APoint2D> embed(int[] ordering, boolean useWeights, boolean noise) {
     ...
     * @return node array of coordinates
     */
    public NodeArray<APoint2D> computeCoords(HashMap<Integer, Double> dirs, Node[] ordering, boolean useWeights) {
        final NodeArray<APoint2D> coords = new NodeArray<>(this);
     ...
     * @param graph
     */
    public void add(OldGraph graph) {
