    ...
    private void doSecondPageTest(Graphics g) {
        ...
        for (String font : fonts) {
            for (int j = 0; j < modes.length; j++) {
                g.setFont(new Font(font, imodes[j], 10));
...
class TestMenuBar extends JMenuBar {
    ...
    final JMenu about;
    final JMenu view;
    final JMenuItem printer;
    final JMenuItem close;
    final JMenuItem helpTopics;
    final JMenuItem aboutApp;
    final JMenuItem viewFirstPage;
    final JMenuItem viewSecondPage;
    ...
    public TestMenuBar(ActionListener parent) {
        ...
        printer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, InputEvent.CTRL_MASK));
